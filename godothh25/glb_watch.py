...
#
# Dependencies:
# pip install watchdog supabase python-dotenv
...
# SUPABASE CREDENTIALS - Set these in your environment variables or .env file
# For security, use environment variables instead of hardcoding keys
SUPABASE_URL = os.getenv("SUPABASE_URL", "https://oushklesskesjkjuoetu.supabase.co/")
SUPABASE_SERVICE_KEY = os.getenv("SUPABASE_SERVICE_KEY")  # Set this in your environment

# SELLER CONFIGURATION - REQUIRED environment variables
...
if __name__ == "__main__":
    ...
    if not SELLER_ID:
        missing_vars.append("SELLER_ID")
    if not SELLER_NAME:
        missing_vars.append("SELLER_NAME")
    
    if missing_vars:
        print(f"❌ Missing required environment variables: {', '.join(missing_vars)}")
        print("💡 Set them in your environment or .env file:")
        print("   export SUPABASE_SERVICE_KEY='your_service_role_key_here'")
        print("   export SELLER_ID='your_seller_id'")
        print("   export SELLER_NAME='your_seller_name'")
        print("   or add to .env file:")
        print("   SUPABASE_SERVICE_KEY=your_service_role_key_here")
        print("   SELLER_ID=your_seller_id")
        print("   SELLER_NAME=your_seller_name")
        exit(1)
